                    ...
                    <ul id="iq-sidebar-toggle" className="iq-menu">
                            ...
                            <ul id="inventory" className="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                                <li className="">
                                    <Link to='listinventory'>
                                        <i className="las la-minus"></i><span>List Inventory</span>
                                    </Link>
                                </li>

                                <li className="">
                                    <Link to='addinventory'>
                                        <i className="las la-minus"></i><span>Add Inventory</span>
                                    </Link>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li className=" ">
                            <a href="#category" className="collapsed" data-toggle="collapse" aria-expanded="false">
                                <svg className="svg-icon" id="p-dash6" width="20" height="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeLinecap="2" stroke-linecap="round" strokeLinejoin="round"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect>
                                    <path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path>
                                </svg>
                            ...
                            <ul id="people" className="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                                ...
                                <li className="">
                                    <Link to='listsupplier'>
                                        <i className="las la-minus"></i><span>ListSuppliers</span>
                                    </Link>
                                </li>
                                <li className="">
                                    <Link to='addsupplier'>
